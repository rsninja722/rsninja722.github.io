...
function mousePosition() {
    // if(drawMode===0) {
    //     return {x:(mousePos.x-251)-camera.x,y:(mousePos.y-31)-camera.y};
    // } else if(drawMode===1) {
        var xoff = canvases.cvs.width/2;
        var yoff = canvases.cvs.height/2;
        return {x:((mousePos.x-251-xoff)/camera.zoom+xoff)-camera.x,y:((mousePos.y-31-yoff)/camera.zoom+yoff)-camera.y};
    // } else {
    //     var xoff = canvases.cvs.width/2;
    //     var yoff = canvases.cvs.height/2;
    //     var tempPos = {x:((mousePos.x-251-xoff)/camera.zoom+xoff)-camera.x,y:((mousePos.y-31-yoff)/camera.zoom+yoff)-camera.y};
...
function resizeBuffers() {
    ...
    canvases.buffer1cvs.width = canvases.cvs.width;
    canvases.buffer1cvs.height = canvases.cvs.height;
...
function setup(physicsFPS) {
    ...
    loadImagesAndSounds();gameStarted=true;
