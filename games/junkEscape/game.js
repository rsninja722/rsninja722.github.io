...
function setup(physicsFPS) {
    ...
    function startButton() {
        ...
        curCtx.drawImage(Math.round(icount/20)%2?i0:i1,0,0);
        if(!gameStarted) {requestAnimationFrame(startButton);}
    }
}
var i0 = new Image();i0.src="assets/images/Tuto_click.png";
    var i1 = new Image();i1.src="assets/images/Tuto_noclick.png";
    var icount = 0;
